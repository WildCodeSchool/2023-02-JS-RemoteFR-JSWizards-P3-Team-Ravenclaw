...
export default function DashNavbar() {
  ...
  return (
    <aside className="hidden md:flex md:flex-col ">
      <nav className="relative min-h-[calc(100vh-80px)] w-11/12 bg-neutralDarkest p-5 pt-8 text-xl font-medium duration-300 md:w-72">
        <ul className="pt-6">
          {Menus.map((menu) => {
            return (
              <li key={menu.id} className={`${styles.dashList}`}>
                <div className="flex items-center ">
                    ...
                    >
                      <g clipPath="url(#clip0_113_1997)">
                        <path
                          ...
                          className="fill-neutralLightest"
                        />
                        <path
                          fillRule="evenodd"
                          clipRule="evenodd"
                  ...
                  <button
                    type="button"
                    className={`w-full decoration-primaryLightest hover:text-primaryLightest md:active:text-primaryLightest ${
                      menu.title !== "Log Out"
